	...
	<div class="container-menu-desktop">
		...
		<div class="top-bar">
			<div class="content-topbar flex-sb-m h-full container">
				<div class="left-top-bar">JavaWeb</div>
		...
		<div class="wrap-menu-desktop how-shadow1">
			<nav class="limiter-menu-desktop container" style=" top: 0px;">
				...
				<a href="#" class="logo"> <img
					src="<c:url value='https://static.vecteezy.com/system/resources/thumbnails/008/147/482/small/modern-bookstore-logo-design-illustration-vector.jpg' />"
