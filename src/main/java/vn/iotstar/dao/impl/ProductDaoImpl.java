...
public class ProductDaoImpl {
	...
	public List<Product> findAll(int offset, int limit) {
		...
		List<Product> listAll = query.getResultList();
		List<Product> top4 = new ArrayList<Product>();
		int i = 1;  // giĂ¡Â»â€˜ng nhĂ†Â° vĂ¡Â»â€¹ trĂƒÂ­ cĂ¡Â»Â§a mĂ¡ÂºÂ£ng , bĂ¡ÂºÂ¯t Ă„â€˜Ă¡ÂºÂ§u tĂ¡Â»Â« 0 	; cĂƒÂ¡c cĂ¡ÂºÂ·p sĂ¡Â»â€˜ bĂ¡ÂºÂ¯t Ă„â€˜Ă¡ÂºÂ§u : 0,3  -> 0,1,2 
...
//		  
//		  List<Product> l2 =
//		  dao.findByProductName("GiĂƒÂ y ThĂ¡Â»Æ’ Thao Nam Hunter X DSMH10500XAM (XĂƒÂ¡m)");
...
//		System.out.println("-----------------------------------------------------------------");
		...
		p1.setProductName("nĂ†Â°Ă¡Â»â€ºc ngĂ¡Â»ï¿½t");
		// mai hoi p1.setStatus(2);
		p1.setCategory(c1);
		p1.setSeller(s1);
