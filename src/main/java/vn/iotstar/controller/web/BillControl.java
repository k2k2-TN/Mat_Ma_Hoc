...
public class BillControl extends HttpServlet {
    ...
    // class gá»“m 3 chá»©c nÄƒng : hiá»ƒn thá»‹ danh sĂ¡ch,hiá»ƒn thá»‹ 1 Ä‘Æ¡n hĂ ng sá»­a vĂ  xĂ³a 
	...
	//hiá»ƒn thá»‹ riĂªng má»™t Ä‘Æ¡n hĂ ng á»©ng vá»›i bill_Id + danh sĂ¡ch nhá»¯ng hĂ ng Ä‘Ă£ Ä‘Æ°á»£c Ä‘áº·t 
...
//			
//			//set cĂ¡c thuá»™c tĂ­nh khĂ³a ngoáº¡i : user vĂ  cart 
//			User user = new User();
