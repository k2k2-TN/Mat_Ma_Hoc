...
/**
 * Servlet implementation class SubtractQuantityControl
 */
@WebServlet("/subtractionquantity")
public class SubtractQuantityControl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SubtractQuantityControl() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		float newprice = unitprice-Float.parseFloat(product.getPrice());
		if(quantity==1)
		{
